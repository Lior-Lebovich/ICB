...
docdir = 'D:\\all hddm analysis\\motor10\\informative priors 40K\\drift'
saved_model_name = 'motor_drift_no_tttv'
os.chdir(docdir)
...
# load raw data:
data = hddm.load_csv('D:\\all hddm analysis\\motor10.csv')
data.rt = data.rt - 0.75 # 750 ms delay
data = data[data.rt<=3]
