...
docdir = 'D:\\all hddm analysis\\g31\\informative priors 40K\\both'
saved_model_name = 'g31_both_no_tttv'
os.chdir(docdir)
...
# load raw data:
data = hddm.load_csv('D:\\all hddm analysis\\data_csv_g31_dl0_3columns.csv')
