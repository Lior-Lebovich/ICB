...
docdir = 'D:\\all hddm analysis\\g33\\informative priors 40K\\both'
saved_model_name = 'g33_both_no_tttv'
os.chdir(docdir)
...
# load raw data:
data = hddm.load_csv('D:\\all hddm analysis\\data_csv_g33_dl0_3columns.csv')
