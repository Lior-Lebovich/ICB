...
docdir = 'D:\\all hddm analysis\\g27\\informative priors 40K\\drift'
saved_model_name = 'g27_drift_no_tttv'
os.chdir(docdir)
...
ppc_data = hddm.utils.post_pred_gen(running_model, append_data=True, 
                                    progress_bar=True, samples=20)
ppc_data.to_csv('ppc_data.csv')

# load raw data:
data = hddm.load_csv('D:\\all hddm analysis\\data_csv_g27_dl0_3columns.csv')
