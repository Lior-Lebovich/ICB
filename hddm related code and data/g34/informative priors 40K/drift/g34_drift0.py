...
docdir = 'D:\\all hddm analysis\\g34\\informative priors 40K\\drift'
saved_model_name = 'g34_drift_no_tttv'
os.chdir(docdir)
...
# load raw data:
data = hddm.load_csv('D:\\all hddm analysis\\data_csv_g34_dl0_3columns.csv')
