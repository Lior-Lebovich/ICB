...
docdir = 'D:\\all hddm analysis\\g32\\informative priors 40K\\both'
saved_model_name = 'g32_both_no_tttv'
os.chdir(docdir)
...
# load raw data:
data = hddm.load_csv('D:\\all hddm analysis\\data_csv_g32_dl0_3columns.csv')
