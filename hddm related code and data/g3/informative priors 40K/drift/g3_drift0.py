...
docdir = 'D:\\all hddm analysis\\g3\\informative priors 40K\\drift'
saved_model_name = 'g3_drift_no_tttv'
os.chdir(docdir)
...
# load raw data:
data = hddm.load_csv('D:\\all hddm analysis\\data_csv_g3_dl0_3columns.csv')
